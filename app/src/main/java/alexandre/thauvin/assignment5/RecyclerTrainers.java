...
public class RecyclerTrainers extends RecyclerView.Adapter<alexandre.thauvin.assignment5.RecyclerTrainers.ViewHolder> {
    ...
    @Override
    public alexandre.thauvin.assignment5.RecyclerTrainers.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.trainer_item, parent, false);
        return new alexandre.thauvin.assignment5.RecyclerTrainers.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final alexandre.thauvin.assignment5.RecyclerTrainers.ViewHolder holder, int position) {
