...
public class SignUpRequest {
    ...
    public static class MakeRequestTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            RequestBody body = RequestBody.create(JSON, bowlingJson(params[0], params[1], params[2]));
            Request request = new Request.Builder()
                    .url("http://163.5.84.111:8081/api/account/signup")
                    .post(body)
                    .build();
        ...
        private String bowlingJson(String email, String password, String confirmPassword) {
